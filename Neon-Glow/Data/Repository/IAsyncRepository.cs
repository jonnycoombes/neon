...
namespace JCS.Neon.Glow.Data.Repository
{
        ...
        where V : KeyedEntity<K>
    {
        ...
        /// <param name="cancellationToken">Optional cancellation token</param>
        /// <returns></returns>
        public Task<V> CreateAsync(V newItem, CancellationToken cancellationToken = default);
        ...
        /// <returns></returns>
        public Task<IEnumerable<V>> CreateAsync(V[] newItems, CancellationToken cancellationToken = default);
