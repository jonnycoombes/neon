...
namespace JCS.Neon.Glow.Statics.Crypto
{
    ...
    public static class SymmetricEncryption
    {
        ...
        public class SymmetricEncryptionException : System.Exception
        {
            public SymmetricEncryptionException(string? message) : base(message)
            {
            }

            public SymmetricEncryptionException(string? message, System.Exception? innerException) : base(message, innerException)
            {
            }
        }
