...
namespace JCS.Neon.Glow.Utilities.Cryptography
{
    ...
    public static class AesSymmetric
    {
        ...
        /// </summary>
        private static ILogger _log = Log.ForContext(typeof(AesSymmetric));
        ...
        public class AesSymmetricEncryptionOptions
        {
            ...
            /// </summary>
            public AesSymmetricKeyUnwrappingOption SymmetricKeyUnwrappingOption { get; set; } = AesSymmetricKeyUnwrappingOption.UnwrapWithPrivateKey;
        ...
        public class AesSymmetricEncryptionOptionsBuilder
        {
            ...
            /// Default constructor
            /// </summary>
            public AesSymmetricEncryptionOptionsBuilder()
            {
            }
        ...
        /// <returns></returns>
        private static byte[] Transform(byte[] source, System.Security.Cryptography.Aes cipher, AesSymmetricTransformDirection direction)
        {
            Logs.MethodCall(_log);
            using (var cryptor =
